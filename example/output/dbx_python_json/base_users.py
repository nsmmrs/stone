...
class Space(object):
    ...
    :
        ...
        """
                ...
                :param long private: The user's used quota outside of shared
                folders (bytes).
                :param long shared: The user's used quota in shared folders
                (bytes).
                :param long datastores: The user's used quota in datastores
                (bytes).
        """
...
class Name(object):
    ...
    :
        ...
        """
                ...
                :param str familiar_name: Locale-dependent familiar name.
                Generally matches ``given_name`` or ``display_name``.
                :param str display_name: A name that can be used directly to
...
class MeInfo(BasicAccountInfo):
    ...
    :
        ...
        """
                ...
                :param Nullable country: The user's two-letter country code, if
                available.
        ...
        :type space: :class:`Space`
                :param Nullable team: If this account is a member of a team.
                :param bool is_paired: Whether the user has a personal and work
                account. If the authorized account is personal, then ``team``
                will always be 'Null', but ``is_paired`` will indicate if a work
                account is linked.
        """
        ...
        if country is not None:
            assert isinstance(country, Nullable), 'country must be of type Nullable'
        ...
        if team is not None:
            assert isinstance(team, Nullable), 'team must be of type Nullable'
        self.team = team
...
class InfoError(object):
    ...
    :
        ...
        Only one argument can be set.
                ...
                :param None no_account: The specified ``account_id`` does not
                exist.
        """
        assert_only_one        ((
