...
class UploadAppend(object):
    ...
    def __init__(self,
        ...
        # # The offset into the file of the current chunk of data being
        # uploaded. It can also be thought of as the amount of data that has
        # been uploaded so far. We use the offset as a sanity check.
        self.offset = offset
...
class UploadCommit(object):
    ...
    def __init__(self,
        ...
        self.path = path
        # # The course of action to take if a file already exists at the given
        # path.
        self.mode = mode
        ...
        # # Whether the devices that the user has linked should notify them of
        # the new or updated file.
        self.mute = mute
